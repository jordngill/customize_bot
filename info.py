...
URL_SHORTENER_END_POINT = environ.get('URL_SHORTENER_END_POINT', '')
URL_SHORTENER_API_KEY = environ.get('URL_SHORTENER_API_KEY', '')
...
CAPTION_BUTTON_URL = "https://youtube.com/@gillharyana"

    # Auto Delete For Bot Sending Files #

# Added 
DELIVERY_CHANNEL = getenv('DELIVERY_CHANNEL')
